...
st.set_page_config(page_title="Podping stats from Pingslurp", page_icon="pages/android-chrome-512x512.png", layout="wide", initial_sidebar_state="auto", menu_items=None)
